...
function Divider(){return <div style={{height:1,background:C.borderLight}}/>}
  ...
  return(
    <div style={{animation:'fadeUp .3s ease'}}>
      ...
      {invRecords.length===0?(
        ...
        <Card>
          {/* 表頭 + 全選 */}
          <div style={{display:'grid',gridTemplateColumns:'36px 36px 1fr 76px 76px 52px 110px 1fr',padding:'10px 16px',background:C.bgWarm,fontSize:10,fontFamily:"'Outfit',sans-serif",color:C.textMuted,letterSpacing:'0.07em',fontWeight:600,textTransform:'uppercase',gap:8,alignItems:'center'}}>
            {/* 全選 checkbox */}
            <input type="checkbox"
